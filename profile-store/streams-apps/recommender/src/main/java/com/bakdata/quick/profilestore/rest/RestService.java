package com.bakdata.quick.profilestore.rest;
...
public class RestService {
    ...
    public RestService(final HostInfo hostInfo, final Map<FieldType, BipartiteGraph> graphs,
            final KafkaStreams kafkaStreams, final Map<FieldType, String> storeNames, final boolean idResolution) {
        this.hostInfo = hostInfo;
        this.resource = new RestResource(graphs, kafkaStreams, storeNames, idResolution);
    }
